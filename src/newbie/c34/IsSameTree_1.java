...
//        }
        ...
        boolean leftflag = isSameTree(root.left,root3.left);
        boolean rightflag = isSameTree(root.right,root3.right);
        boolean middleflag = root.v == root3.v;

       return  leftflag && rightflag && middleflag;
    }
